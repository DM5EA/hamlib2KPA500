...
So based on this I started this python project. In my case the elecraft KPA500 and the ICOM 7610 are connected to a Raspberry 4. The script
...
![]()<img src=kpa500_remote.0.4.2.png height=503> ![]()<img src=hamlib2kpa500_display.JPG height=503>
